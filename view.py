...
class Axis_Setting_Widget(QWidget):
	...
	def setup_ui(self):
		self.XSetting_widget = AxisSetting("X")
		self.YSetting_widget = AxisSetting("Y")
		layout = QHBoxLayout()
